...
# Секретный ключ для сессий (можно оставить так, он не критичен)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'hard-to-guess-string')

# ⚠️ ВСТАВЬ СВОЙ API-КЛЮЧ YOUTUBE (начинается с AIza...)
YOUTUBE_API_KEY = 'AIzaSyDo6Y4cxMa073cjkkuVDeuKColw9JbcK3w'  # замени на свой реальный ключ
VIDEO_ID = 'zYrpEl61uCI'

# Три базовых заголовка безопасности (не влияют на работу)
@app.after_request
